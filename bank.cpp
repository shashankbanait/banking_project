...
public:
    BankAccount(int acc_number, const string& n, const string& addr, const string& contact, double initial_balance, const string& curr)
        : account_number(acc_number), name(n), address(addr), contact_details(contact), balance(initial_balance), currency(curr) {}
...
void create_account(vector<BankAccount>& accounts) {
    ...
    string name, address, contact_details, currency;
    ...
    if (initial_deposit >= 0) {
        BankAccount new_account(account_number, name, address, contact_details, initial_deposit, currency);
